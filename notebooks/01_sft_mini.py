...
#
# `5CD-AI/Vietnamese-alpaca-gpt4-gg-translated` is the default VN Alpaca-style
# SFT source for this lab. We keep the 1k slice so the SFT step stays T4-friendly
